...
#    Updated: 2023/08/09 09:53:31 by ghwa             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_putnbr_fd.c ft_putendl_fd.c ft_putstr_fd.c ft_putchar_fd.c \
	  ...
	  ft_memset.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft_strlcat.c ft_strlcpy.c \
	  ft_strlcat.c ft_strlcpy.c ft_strlen.c ft_strncmp.c ft_strnstr.c ft_lstmap.c \
	  ft_lstiter.c ft_lstclear.c ft_lstdelone.c ft_lstnew.c ft_lstlast.c ft_lstsize.c \
	  ft_lstadd_front.c ft_lstadd_back.c ft_printf.c ft_printf_utils.c
OBJECT = ${SRC:.c=.o}
